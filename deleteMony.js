...
async function main(){
    ...
    //const result = await userCollection.deleteMany({Name:"Azad1"});
    //const result = await userCollection.deleteMany({"address.province":"Kordestan2"});
    const result = await userCollection.findOneAndDelete({Name:"Azad3"});
    ...
    console.log("DeleteMony Documents => ", result);
}
